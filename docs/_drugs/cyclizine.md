...
**備註**：泰國市場上有多種 cyclizine 衍生物製劑，但許多已註銷。目前有效的製劑主要用於暈動症及過敏。
...
**APA 格式：**
```
ThTxGNN. (2026). Cyclizine老藥新用驗證報告. https://thtxgnn.yao.care/drugs/cyclizine/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_cyclizine,
  title = {Cyclizine老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/cyclizine/}
}
```
