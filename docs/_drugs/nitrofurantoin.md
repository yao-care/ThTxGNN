...
**APA 格式：**
```
ThTxGNN. (2026). Nitrofurantoin老藥新用驗證報告. https://thtxgnn.yao.care/drugs/nitrofurantoin/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_nitrofurantoin,
  title = {Nitrofurantoin老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/nitrofurantoin/}
}
```
