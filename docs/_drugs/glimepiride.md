...
layout: default
title: "Glimepiride"
description: "รายงานการวิเคราะห์ศักยภาพการใช้ยา Glimepiride ในข้อบ่งใช้ใหม่ - ThTxGNN"
...
| **เลขทะเบียนยา** | 1A 29/67 |
| **ข้อบ่งใช้เดิม** | เบาหวานชนิดที่ 2 |
| **ข้อบ่งใช้ที่คาดการณ์อันดับ 1** | diabetes mellitus (disease) |
...
|:------:|---------------------|:-----------:|
| 1 | diabetes mellitus (disease) | 0.9977 |
| 2 | classic stiff person syndrome | 0.9975 |
| 3 | focal stiff limb syndrome | 0.9975 |
| 4 | opsismodysplasia | 0.9974 |
| 5 | thiamine-responsive dysfunction syndrome | 0.9973 |
| 6 | drug-induced localized lipodystrophy | 0.9962 |
| 7 | centrifugal lipodystrophy | 0.9960 |
| 8 | pressure-induced localized lipoatrophy | 0.9959 |
| 9 | idiopathic localized lipodystrophy | 0.9956 |
| 10 | pancreatic agenesis | 0.9955 |
...
- [DrugBank: Glimepiride](https://go.drugbank.com/drugs/DB00222)
- [PubMed: Glimepiride](https://pubmed.ncbi.nlm.nih.gov/?term=Glimepiride)
- [ClinicalTrials.gov](https://clinicaltrials.gov/search?term=Glimepiride)
