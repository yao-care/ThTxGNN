...
**APA 格式：**
```
ThTxGNN. (2026). Polyethylene Glycol老藥新用驗證報告. https://thtxgnn.yao.care/drugs/polyethylene_glycol/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_polyethylene_glycol,
  title = {Polyethylene Glycol老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/polyethylene_glycol/}
}
```
