...
layout: default
title: "Vitamind"
description: "รายงานการวิเคราะห์ศักยภาพการใช้ยา Vitamind ในข้อบ่งใช้ใหม่ - ThTxGNN"
...
| **เลขทะเบียนยา** | 1A 98/67 |
| **ข้อบ่งใช้เดิม** | ป้องกันและรักษาภาวะขาดวิตามินดี |
| **ข้อบ่งใช้ที่คาดการณ์อันดับ 1** | primary release disorder of platelets |
| **คะแนน TxGNN สูงสุด** | 0.9311 |
| **ระดับหลักฐาน** | L5 |
...
|:------:|---------------------|:-----------:|
| 1 | primary release disorder of platelets | 0.9311 |
| 2 | sclerosing cholangitis | 0.9238 |
| 3 | pseudo-von Willebrand disease | 0.9152 |
| 4 | cholecystolithiasis | 0.9057 |
| 5 | multiple endocrine neoplasia | 0.9019 |
| 6 | Glanzmann thrombasthenia | 0.8780 |
| 7 | familial isolated hypoparathyroidism due to impaired PTH secretion | 0.8516 |
| 8 | acromesomelic dysplasia, Campailla Martinelli type | 0.8506 |
| 9 | hypoparathyroidism | 0.8407 |
| 10 | craniofacial conodysplasia | 0.8391 |
...
- [DrugBank: Vitamind](https://go.drugbank.com/drugs/DB11094)
- [PubMed: Vitamind](https://pubmed.ncbi.nlm.nih.gov/?term=Vitamind)
- [ClinicalTrials.gov](https://clinicaltrials.gov/search?term=Vitamind)
