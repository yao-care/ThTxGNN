...
layout: default
title: "Metformin"
description: "รายงานการวิเคราะห์ศักยภาพการใช้ยา Metformin ในข้อบ่งใช้ใหม่ - ThTxGNN"
...
| **เลขทะเบียนยา** | 1A 26/67 |
| **ข้อบ่งใช้เดิม** | เบาหวานชนิดที่ 2 |
| **ข้อบ่งใช้ที่คาดการณ์อันดับ 1** | focal stiff limb syndrome |
| **คะแนน TxGNN สูงสุด** | 0.9945 |
| **ระดับหลักฐาน** | L4 |
...
|:------:|---------------------|:-----------:|
| 1 | focal stiff limb syndrome | 0.9945 |
| 2 | classic stiff person syndrome | 0.9945 |
| 3 | diabetes mellitus (disease) | 0.9943 |
| 4 | opsismodysplasia | 0.9940 |
| 5 | thiamine-responsive dysfunction syndrome | 0.9940 |
| 6 | drug-induced localized lipodystrophy | 0.9906 |
| 7 | centrifugal lipodystrophy | 0.9899 |
| 8 | pressure-induced localized lipoatrophy | 0.9896 |
| 9 | pancreatic agenesis | 0.9891 |
| 10 | idiopathic localized lipodystrophy | 0.9890 |
...
- [PubMed: Metformin](https://pubmed.ncbi.nlm.nih.gov/?term=Metformin)
- [ClinicalTrials.gov](https://clinicaltrials.gov/search?term=Metformin)
