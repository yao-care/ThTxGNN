...
<p class="key-answer" data-question="Moclobemide 可以用於治療什麼新適應症？">
...
| DrugBank ID | DB01171 |
| 泰國商品名 | 歐蕾思膜衣錠、憂停膜衣錠、憂適解膜衣錠、保鬱舒膜衣錠 |
| 原核准適應症 | 憂鬱症、社交畏懼症 |
| 預測新適應症 | dysthymic disorder、焦慮症 |
| 最高預測分數 | 0.9943（廣場恐懼症） |
| 證據等級 | L2（單一 RCT） |
...
**含酪胺食物（陳年起司、醃製品、紅酒）** 🔴 Major
- 影響：MAO 抑制劑與高酪胺食物併用可能引發高血壓危象
- 建議：避免陳年起司、醃製肉品、發酵食品

### 藥物-草藥交互作用 (DHI)

**聖約翰草（貫葉連翹）** 🔴 Major
- 影響：雙重 MAO 抑制作用，可能導致血清素症候群
- 建議：禁止併用

**人參** 🟡 Moderate
- 影響：人參可能與 MAO 抑制劑產生交互作用
- 建議：避免併用
...
*報告產生日期：2026-02-11*
*資料來源：TxGNN 預測、ClinicalTrials.gov、PubMed、泰國 FDA*
...
- [Pentosan Polysulfate]({{ "/drugs/pentosan_polysulfate/" | relative_url }}) - 證據等級 L5
...
**APA 格式：**
```
ThTxGNN. (2026). Moclobemide老藥新用驗證報告. https://thtxgnn.yao.care/drugs/moclobemide/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_moclobemide,
  title = {Moclobemide老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/moclobemide/}
}
```
