...
**注意**：泰國已核准 pembrolizumab 與 pemetrexed 及含鉑化療併用，作為無法切除之晚期或轉移性惡性胸膜間皮瘤的第一線治療。
...
**APA 格式：**
```
ThTxGNN. (2026). Pemetrexed老藥新用驗證報告. https://thtxgnn.yao.care/drugs/pemetrexed/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_pemetrexed,
  title = {Pemetrexed老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/pemetrexed/}
}
```
