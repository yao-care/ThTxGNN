...
description: "Pentosan Polysulfate 的老藥新用潛力分析。模型預測等級 L5，包含 3 個預測適應症。查看 AI 預測與臨床證據完整報告。"
parent: 僅模型預測 (L5)
nav_order: 124
evidence_level: L5
indication_count: 3
...
<p class="key-answer" data-question="Pentosan Polysulfate 可以用於治療什麼新適應症？">
...
**APA 格式：**
```
ThTxGNN. (2026). Pentosan Polysulfate老藥新用驗證報告. https://thtxgnn.yao.care/drugs/pentosan_polysulfate/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_pentosan_polysulfate,
  title = {Pentosan Polysulfate老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/pentosan_polysulfate/}
}
```
