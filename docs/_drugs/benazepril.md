...
| 衛署藥製字第057325號 | 壓諾本錠 | 錠劑 | 泰國東洋藥品 | 2027/08/10 |
...
- 需定期監測。風險包括：骨髓抑制、血栓、貧血。

**心臟衰竭** 🟢 Minor
- 應謹慎使用本藥物。需密切監測。風險包括：低血壓。可能有致命風險。必要時應停止治療。

**Diseases requiring hemodialysis** 🟢 Minor
- 注意事項：Anaphylactoid reactions have been reported in patients undergoing hemodialysis with high-flux polyacrylonitrile membranes and treated concomitantly wi...
...
**APA 格式：**
```
ThTxGNN. (2026). Benazepril老藥新用驗證報告. https://thtxgnn.yao.care/drugs/benazepril/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_benazepril,
  title = {Benazepril老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/benazepril/}
}
```
