...
<p class="key-answer" data-question="Pimozide 可以用於治療什麼新適應症？">
...
### 上市狀態
泰國已核准上市，共有 11 張許可證，目前有效許可證 2 張。

### 代表性產品

| 許可證字號 | 商品名 | 劑型 | 許可證持有者 | 效期 |
|------------|--------|------|--------------|------|
| 衛署藥製字第043118號 | 十全杜鬱錠2毫克 | 錠劑 | 十全實業股份有限公司 | 2029/07/21 |
| 衛署藥製字第044175號 | 活潑錠 | 錠劑 | 井田國際醫藥廠股份有限公司 | 2030/12/20 |
...
DDInter 資料庫顯示 Pimozide 與多種藥物有交互作用：

**嚴重交互作用 (Major)**：
- Hydrocortisone
- Amphotericin B
- 可能延長 QT 間距，需特別注意心臟安全性
...
### 注意事項
1. **QT 延長風險**：Pimozide 可延長 QT 間距，禁止與其他延長 QT 藥物併用
...
**聖約翰草（貫葉連翹）** 🔴 Major
- 影響：聖約翰草降低 Pimozide 血中濃度，可能影響療效
- 建議：禁止併用
...
### 建議
1. **躁鬱症**：已有充分文獻支持 Pimozide 對躁症的療效，但需注意 QT 延長風險
2. **拔毛症**：可作為 SSRI 治療無效時的輔助治療選項
3. 任何新適應症使用前需進行完整心電圖評估
...
**APA 格式：**
```
ThTxGNN. (2026). Pimozide老藥新用驗證報告. https://thtxgnn.yao.care/drugs/pimozide/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_pimozide,
  title = {Pimozide老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/pimozide/}
}
```
