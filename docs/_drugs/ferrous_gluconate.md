...
description: "Ferrous Gluconate 的老藥新用潛力分析。模型預測等級 L5，包含 5 個預測適應症。查看 AI 預測與臨床證據完整報告。"
parent: 僅模型預測 (L5)
nav_order: 73
evidence_level: L3
indication_count: 5
...
<p class="key-answer" data-question="Ferrous Gluconate 可以用於治療什麼新適應症？">
...
| 泰國商品名 | 葡萄糖酸鐵糖衣錠、維他葡萄糖鐵糖衣錠、血命健糖衣片等 |
| DrugBank ID | DB14488 |
...
*報告生成日期：2026-02-11*
*資料來源：TxGNN 知識圖譜預測、ClinicalTrials.gov、PubMed、泰國 FDA*
...
**APA 格式：**
```
ThTxGNN. (2026). Ferrous Gluconate老藥新用驗證報告. https://thtxgnn.yao.care/drugs/ferrous_gluconate/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_ferrous_gluconate,
  title = {Ferrous Gluconate老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/ferrous_gluconate/}
}
```
