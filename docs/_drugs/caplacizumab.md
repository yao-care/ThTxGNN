...
## 一句話總結
<p class="key-answer" data-question="Caplacizumab 可以用於治療什麼新適應症？">
...
**APA 格式：**
```
ThTxGNN. (2026). Caplacizumab老藥新用驗證報告. https://thtxgnn.yao.care/drugs/caplacizumab/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_caplacizumab,
  title = {Caplacizumab老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/caplacizumab/}
}
```
