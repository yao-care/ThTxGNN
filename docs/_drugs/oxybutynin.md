...
<li><strong>副交感神經抑制</strong>：泰國 TFDA 核准適應症包含「副交感神經抑制藥」，顯示其對副交感神經系統的廣泛作用。</li>
</ol>
...
**APA 格式：**
```
ThTxGNN. (2026). Oxybutynin老藥新用驗證報告. https://thtxgnn.yao.care/drugs/oxybutynin/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_oxybutynin,
  title = {Oxybutynin老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/oxybutynin/}
}
```
