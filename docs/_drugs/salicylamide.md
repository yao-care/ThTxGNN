...
layout: default
title: Salicylamide
description: "Salicylamide 的老藥新用潛力分析。初步證據等級 L4，包含 10 個預測適應症。查看 AI 預測與臨床證據完整報告。"
parent: 中證據等級 (L3-L4)
nav_order: 153
evidence_level: L4
indication_count: 10
...
# Salicylamide：從解熱鎮痛到感冒相關疾病

## 一句話總結

<p class="key-answer" data-question="Salicylamide 可以用於治療什麼新適應症？">
Salicylamide 原本用於解熱鎮痛。TxGNN 模型預測它可能對**普通感冒 (common cold)** 及**咽炎 (pharyngitis)** 有效，這些預測獲得多篇歷史文獻支持。
</p>
...
| 許可證號 | 品名 | 劑型 | 狀態 | 核准適應症 |
|---------|------|------|------|-----------|
| 衛部藥輸字第027398號 | 水楊醯胺 | 粉末 | 有效 | 鎮痛藥 |
| 衛署藥製字第020224號 | "人生"必治僂糖衣錠 | 糖衣錠 | 有效 | 退燒、止痛 |
| 衛署藥製字第022383號 | "生達"安治痛錠 | 錠劑 | 有效 | 退燒、止痛 |

## 安全性考量

### 藥物交互作用

目前 DDInter 資料庫中無 Salicylamide 的重大藥物交互作用記錄。

### 特殊注意事項

- **過量毒性**：有文獻報告過量使用導致毒性反應
- **肝代謝**：主要經葡萄糖醛酸化代謝，肝功能不全者需注意
- **類水楊酸反應**：可能發生類似阿斯匹靈的過敏反應

### 與阿斯匹靈的差異

根據文獻，阿斯匹靈過敏的患者可能可以安全使用 Salicylamide，因為其抑制環氧化酶的能力較弱。
...
**APA 格式：**
```
ThTxGNN. (2026). Salicylamide老藥新用驗證報告. https://thtxgnn.yao.care/drugs/salicylamide/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_salicylamide,
  title = {Salicylamide老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/salicylamide/}
}
```
