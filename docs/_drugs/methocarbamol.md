...
| DrugBank ID | DB00423 |
| 泰國商品名 | 佳復筋片、達士邦錠、寶樂欣膜衣錠、肌樂弛錠、美卡欣錠 |
...
**APA 格式：**
```
ThTxGNN. (2026). Methocarbamol老藥新用驗證報告. https://thtxgnn.yao.care/drugs/methocarbamol/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_methocarbamol,
  title = {Methocarbamol老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/methocarbamol/}
}
```
