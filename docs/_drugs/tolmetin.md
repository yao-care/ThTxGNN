...
**APA 格式：**
```
ThTxGNN. (2026). Tolmetin老藥新用驗證報告. https://thtxgnn.yao.care/drugs/tolmetin/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_tolmetin,
  title = {Tolmetin老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/tolmetin/}
}
```
