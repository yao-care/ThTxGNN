...
<p class="key-answer" data-question="Tyrosine 可以用於治療什麼新適應症？">
...
|------------|----------|------|--------------|------|
| 衛署藥輸字第004172號 | 協和 L-酪氨酸 | 原料藥 | 裕元興業 | 已註銷 |
| 衛署藥輸字第006340號 | 味之素 乾酪氨酸 | 原料藥 | 東信化學 | 已註銷 |
| 衛署藥輸字第007503號 | 左酪氨酸 | 原料藥 | 興源藥品 | 已註銷 |
| 衛署藥輸字第021614號 | 乾酪氨酸 | 原料藥 | 臺田藥品 | 已註銷 |
...
**APA 格式：**
```
ThTxGNN. (2026). Tyrosine老藥新用驗證報告. https://thtxgnn.yao.care/drugs/tyrosine/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_tyrosine,
  title = {Tyrosine老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/tyrosine/}
}
```
