...
**APA 格式：**
```
ThTxGNN. (2026). Tranexamic Acid老藥新用驗證報告. https://thtxgnn.yao.care/drugs/tranexamic_acid/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_tranexamic_acid,
  title = {Tranexamic Acid老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/tranexamic_acid/}
}
```
