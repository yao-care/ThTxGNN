...
<p class="key-answer" data-question="Gemcitabine 可以用於治療什麼新適應症？">
...
<details class="indication-section">
<summary>
<span class="indication-name">5. villoglandular endometrial endometrioid adenocarcinoma</span>
...
<details class="indication-section">
<summary>
<span class="indication-name">9. rete ovarii adenocarcinoma</span>
<span class="evidence-badge evidence-L5">L5</span>
...
<details class="indication-section">
<summary>
<span class="indication-name">10. secretory uterine corpus endometrioid adenocarcinoma</span>
<span class="evidence-badge evidence-L5">L5</span>
<span class="prediction-score">99.73%</span>
</summary>
<div class="indication-content">
...
**APA 格式：**
```
ThTxGNN. (2026). Gemcitabine老藥新用驗證報告. https://thtxgnn.yao.care/drugs/gemcitabine/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_gemcitabine,
  title = {Gemcitabine老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/gemcitabine/}
}
```
