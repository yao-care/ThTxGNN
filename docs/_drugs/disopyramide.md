...
**現況**：泰國僅剩一項有效許可證，其他製劑均已註銷。市場供應有限。
...
**APA 格式：**
```
ThTxGNN. (2026). Disopyramide老藥新用驗證報告. https://thtxgnn.yao.care/drugs/disopyramide/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_disopyramide,
  title = {Disopyramide老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/disopyramide/}
}
```
