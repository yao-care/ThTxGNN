...
layout: default
title: "Valproicacid"
description: "รายงานการวิเคราะห์ศักยภาพการใช้ยา Valproicacid ในข้อบ่งใช้ใหม่ - ThTxGNN"
parent: หลักฐานอ่อน (L4)
nav_order: 1
drug_name: "Valproicacid"
drugbank_id: "DB00313"
evidence_level: "L4"
indication_count: 10
---
...
| **เลขทะเบียนยา** | 1A 83/67 |
| **ข้อบ่งใช้เดิม** | โรคลมชัก, โรคไบโพลาร์ |
| **ข้อบ่งใช้ที่คาดการณ์อันดับ 1** | trigeminal nerve neoplasm |
...
|:------:|---------------------|:-----------:|
| 1 | trigeminal nerve neoplasm | 0.9997 |
| 2 | visual epilepsy | 0.9988 |
| 3 | trigeminal neuralgia | 0.9983 |
| 4 | orgasm-induced seizures | 0.9981 |
| 5 | startle epilepsy | 0.9981 |
| 6 | thinking seizures | 0.9981 |
| 7 | audiogenic seizures | 0.9981 |
| 8 | eating seizures | 0.9981 |
| 9 | micturation-induced seizures | 0.9981 |
| 10 | reading seizures | 0.9979 |
...
- [DrugBank: Valproicacid](https://go.drugbank.com/drugs/DB00313)
- [PubMed: Valproicacid](https://pubmed.ncbi.nlm.nih.gov/?term=Valproicacid)
- [ClinicalTrials.gov](https://clinicaltrials.gov/search?term=Valproicacid)
