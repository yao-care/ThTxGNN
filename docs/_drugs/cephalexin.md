...
layout: default
title: Cephalexin
description: "Cephalexin 的老藥新用潛力分析。模型預測等級 L5。查看 AI 預測與臨床證據完整報告。"
parent: 僅模型預測 (L5)
nav_order: 44
evidence_level: L5
indication_count: 0
...
<p class="key-answer" data-question="Cephalexin 可以用於治療什麼新適應症？">
...
**注意**：泰國有多家廠商生產 cephalexin 製劑，總許可證數達 313 張，顯示此藥物在臨床上的廣泛使用。
...
**APA 格式：**
```
ThTxGNN. (2026). Cephalexin老藥新用驗證報告. https://thtxgnn.yao.care/drugs/cephalexin/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_cephalexin,
  title = {Cephalexin老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/cephalexin/}
}
```
