...
| DrugBank ID | DB00987 |
| 泰國商品名 | 複方製劑中的成分，如 Midostaurin 併用方案 |
...
**APA 格式：**
```
ThTxGNN. (2026). Cytarabine老藥新用驗證報告. https://thtxgnn.yao.care/drugs/cytarabine/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_cytarabine,
  title = {Cytarabine老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/cytarabine/}
}
```
