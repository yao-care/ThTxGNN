...
泰國有大量含 Thiamine 的產品（超過 2,800 項），主要類型：
...
**APA 格式：**
```
ThTxGNN. (2026). Thiamine老藥新用驗證報告. https://thtxgnn.yao.care/drugs/thiamine/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_thiamine,
  title = {Thiamine老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/thiamine/}
}
```
