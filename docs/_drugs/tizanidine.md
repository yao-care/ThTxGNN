...
<p class="key-answer" data-question="Tizanidine 可以用於治療什麼新適應症？">
...
Tizanidine 在泰國有多張有效許可證：

| 許可證字號 | 品名 | 劑量 | 許可證持有者 | 效期 |
|-----------|------|------|-------------|------|
| 衛署藥輸字第019626號 | 鬆得樂錠 | 2mg | 泰國山德士 | 2027/11/27 |
...
**APA 格式：**
```
ThTxGNN. (2026). Tizanidine老藥新用驗證報告. https://thtxgnn.yao.care/drugs/tizanidine/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_tizanidine,
  title = {Tizanidine老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/tizanidine/}
}
```
