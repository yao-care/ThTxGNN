...
**APA 格式：**
```
ThTxGNN. (2026). Cerliponase Alfa老藥新用驗證報告. https://thtxgnn.yao.care/drugs/cerliponase_alfa/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_cerliponase_alfa,
  title = {Cerliponase Alfa老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/cerliponase_alfa/}
}
```
