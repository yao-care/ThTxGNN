...
<p class="key-answer" data-question="Metoprolol 可以用於治療什麼新適應症？">
...
<details class="indication-section">
<summary>
<span class="indication-name">6. posteroinferior myocardial infarction</span>
<span class="evidence-badge evidence-L5">L5</span>
...
<details class="indication-section">
<summary>
<span class="indication-name">7. posterolateral myocardial infarction</span>
<span class="evidence-badge evidence-L5">L5</span>
<span class="prediction-score">99.84%</span>
</summary>
<div class="indication-content">
...
<details class="indication-section">
<summary>
<span class="indication-name">10. trichotillomania</span>
<span class="evidence-badge evidence-L5">L5</span>
...
**甲狀腺機能亢進** 🟡 Moderate
- 注意事項：During chronic administration, the clearance of beta-blockers that are primarily metabolized by the liver (e...
...
**APA 格式：**
```
ThTxGNN. (2026). Metoprolol老藥新用驗證報告. https://thtxgnn.yao.care/drugs/metoprolol/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_metoprolol,
  title = {Metoprolol老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/metoprolol/}
}
```
