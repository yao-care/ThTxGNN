...
# Isosorbide Dinitrate：從 狹心症 到 肺高壓

## 一句話總結

<p class="key-answer" data-question="Isosorbide Dinitrate 可以用於治療什麼新適應症？">
...
| 項目 | 內容 |
|------|------|
| 原適應症 | 預防及治療狹心症發作、冠狀動脈不全 |
| 預測新適應症 | 肺高壓 (pulmonary hypertension)、脫髮症 (alopecia) |
| TxGNN 預測分數 | 99.98% (肺高壓) |
| 證據等級 | L2 |
| 泰國上市 | 已上市 |
| 許可證數 | 多張 |
| 建議決策 | Explore |
...
<details class="indication-section">
<summary>
<span class="indication-name">7. hypertrichosis (disease)</span>
<span class="evidence-badge evidence-L5">L5</span>
<span class="prediction-score">99.97%</span>
</summary>
<div class="indication-content">
...
<details class="indication-section">
<summary>
<span class="indication-name">8. kyphoscoliotic heart disease</span>
<span class="evidence-badge evidence-L5">L5</span>
...
<details class="indication-section">
<summary>
<span class="indication-name">9. visceral calciphylaxis</span>
<span class="evidence-badge evidence-L5">L5</span>
<span class="prediction-score">99.96%</span>
</summary>
<div class="indication-content">
...
<details class="indication-section">
<summary>
<span class="indication-name">10. arterial thoracic outlet syndrome</span>
<span class="evidence-badge evidence-L5">L5</span>
...
| 許可證號 | 品名 | 劑型 | 核准適應症 |
|---------|------|------|-----------|
| 多張許可證 | 富利心舌下錠等 | 舌下錠/錠劑 | 預防狹心症發作、冠狀動脈不全、心絞痛 |
...
**禁忌症：**
- 與 PDE5 抑制劑（如 sildenafil）併用：可能導致嚴重低血壓
- 嚴重低血壓
- 右心室梗塞
- 肥厚性心肌病變伴流出道阻塞
...
**理由：**
ISDN 對肺高壓的治療具有清晰的藥理機轉和豐富的文獻支持。多項研究顯示它能有效降低肺動脈壓力。然而，全身性血管擴張作用可能限制其在前毛細血管性肺高壓的應用。目前肺動脈高壓的標準治療已有更選擇性的藥物（如前列環素類似物、PDE5 抑制劑），ISDN 可能更適合作為輔助治療或特定亞群的替代選擇。

**若要推進需要：**
- 明確 ISDN 在不同類型肺高壓中的定位
- 與現有標準治療的比較研究
...
**APA 格式：**
```
ThTxGNN. (2026). Isosorbide Dinitrate老藥新用驗證報告. https://thtxgnn.yao.care/drugs/isosorbide_dinitrate/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_isosorbide_dinitrate,
  title = {Isosorbide Dinitrate老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/isosorbide_dinitrate/}
}
```
