...
layout: default
title: "Domperidone"
description: "รายงานการวิเคราะห์ศักยภาพการใช้ยา Domperidone ในข้อบ่งใช้ใหม่ - ThTxGNN"
...
| **เลขทะเบียนยา** | 1A 44/67 |
| **ข้อบ่งใช้เดิม** | คลื่นไส้อาเจียน, อาหารไม่ย่อย |
| **ข้อบ่งใช้ที่คาดการณ์อันดับ 1** | nephrogenic syndrome of inappropriate antidiuresis |
| **คะแนน TxGNN สูงสุด** | 0.9908 |
| **ระดับหลักฐาน** | L4 |
...
|:------:|---------------------|:-----------:|
| 1 | nephrogenic syndrome of inappropriate antidiuresis | 0.9908 |
| 2 | Plasmodium falciparum malaria | 0.9873 |
| 3 | common cold | 0.9702 |
| 4 | headache disorder | 0.9672 |
| 5 | allergic urticaria | 0.9636 |
| 6 | trigeminal autonomic cephalalgia | 0.9625 |
| 7 | collagenopathy | 0.9568 |
| 8 | renin-angiotensin-aldosterone system-blocker-induced angioedema | 0.9564 |
| 9 | lymphocytic hypereosinophilic syndrome | 0.9550 |
| 10 | hypertrichosis (disease) | 0.9528 |
...
- [PubMed: Domperidone](https://pubmed.ncbi.nlm.nih.gov/?term=Domperidone)
- [ClinicalTrials.gov](https://clinicaltrials.gov/search?term=Domperidone)
