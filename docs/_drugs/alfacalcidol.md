...
layout: default
title: Alfacalcidol
description: "Alfacalcidol 的老藥新用潛力分析。中等證據等級 L3，包含 5 個預測適應症。查看 AI 預測與臨床證據完整報告。"
parent: 中證據等級 (L3-L4)
nav_order: 14
evidence_level: L4
indication_count: 5
...
證據等級: <strong>L3</strong> | 預測適應症: <strong>5</strong> 個
</p>
...
<p class="key-answer" data-question="Alfacalcidol 可以用於治療什麼新適應症？">
...
- Cholestyramine：減少 alfacalcidol 吸收
- Phenytoin、Phenobarbital：加速維生素 D 代謝
- Magnesium 類制酸劑（慢性腎病患者）：增加高鎂血症風險
...
**APA 格式：**
```
ThTxGNN. (2026). Alfacalcidol老藥新用驗證報告. https://thtxgnn.yao.care/drugs/alfacalcidol/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_alfacalcidol,
  title = {Alfacalcidol老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/alfacalcidol/}
}
```
