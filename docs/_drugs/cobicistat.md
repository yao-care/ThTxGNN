...
| 藥物名稱 | Cobicistat |
| DrugBank ID | DB09065 |
| 泰國商品名 | 信澤力膜衣錠 (Symtuza)、捷扶康膜衣錠 (Genvoya)、普澤力膜衣錠 (Prezcobix) |
...
**重點**：Cobicistat 在泰國僅以複方形式上市，不作為單方藥品使用。
...
**APA 格式：**
```
ThTxGNN. (2026). Cobicistat老藥新用驗證報告. https://thtxgnn.yao.care/drugs/cobicistat/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_cobicistat,
  title = {Cobicistat老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/cobicistat/}
}
```
