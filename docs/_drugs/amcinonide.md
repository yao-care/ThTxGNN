...
證據等級: <strong>L3</strong> | 預測適應症: <strong>8</strong> 個
</p>
...
<p class="key-answer" data-question="Amcinonide 可以用於治療什麼新適應症？">
...
**APA 格式：**
```
ThTxGNN. (2026). Amcinonide老藥新用驗證報告. https://thtxgnn.yao.care/drugs/amcinonide/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_amcinonide,
  title = {Amcinonide老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/amcinonide/}
}
```
