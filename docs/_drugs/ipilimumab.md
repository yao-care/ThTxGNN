...
| 許可證字號 | 商品名 | 許可證持有者 | 效期 |
|------------|--------|--------------|------|
| 衛部菌疫輸字第000958號 | 益伏注射劑 5 毫克/毫升 | 泰國必治妥施貴寶 | 2029/08/18 |
...
**APA 格式：**
```
ThTxGNN. (2026). Ipilimumab老藥新用驗證報告. https://thtxgnn.yao.care/drugs/ipilimumab/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_ipilimumab,
  title = {Ipilimumab老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/ipilimumab/}
}
```
