...
**聖約翰草（貫葉連翹）** 🔴 Major
- 影響：聖約翰草顯著降低 Ritonavir 血中濃度，可能導致 HIV 治療失敗
- 建議：絕對禁止併用
...
**APA 格式：**
```
ThTxGNN. (2026). Ritonavir老藥新用驗證報告. https://thtxgnn.yao.care/drugs/ritonavir/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_ritonavir,
  title = {Ritonavir老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/ritonavir/}
}
```
