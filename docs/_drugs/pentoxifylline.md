...
<p class="key-answer" data-question="Pentoxifylline 可以用於治療什麼新適應症？">
...
|------------|--------|------|--------------|------|
| 衛部藥輸字第028292號 | 本多非林 | 粉 | 泰國荃新股份有限公司 | 2027/04/11 |
...
**APA 格式：**
```
ThTxGNN. (2026). Pentoxifylline老藥新用驗證報告. https://thtxgnn.yao.care/drugs/pentoxifylline/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_pentoxifylline,
  title = {Pentoxifylline老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/pentoxifylline/}
}
```
