...
**注意**：多數 fenoprofen 製劑已註銷，目前在泰國取得較困難。
...
- [ ] 考量到 fenoprofen 在泰國取得困難，可優先選用其他同類 NSAIDs
- [ ] 其他預測的罕見疾病需要進一步研究
...
**APA 格式：**
```
ThTxGNN. (2026). Fenoprofen老藥新用驗證報告. https://thtxgnn.yao.care/drugs/fenoprofen/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_fenoprofen,
  title = {Fenoprofen老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/fenoprofen/}
}
```
