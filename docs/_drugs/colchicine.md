...
layout: default
title: "Colchicine"
description: "รายงานการวิเคราะห์ศักยภาพการใช้ยา Colchicine ในข้อบ่งใช้ใหม่ - ThTxGNN"
...
| **เลขทะเบียนยา** | 1A 89/67 |
| **ข้อบ่งใช้เดิม** | เก๊าต์เฉียบพลัน |
| **ข้อบ่งใช้ที่คาดการณ์อันดับ 1** | autosomal recessive familial Mediterranean fever |
| **คะแนน TxGNN สูงสุด** | 0.9969 |
| **ระดับหลักฐาน** | L4 |
...
|:------:|---------------------|:-----------:|
| 1 | autosomal recessive familial Mediterranean fever | 0.9969 |
| 2 | Plasmodium falciparum malaria | 0.9960 |
| 3 | familial Mediterranean fever, autosomal dominant | 0.9938 |
| 4 | dermatofibrosarcoma protuberans | 0.9937 |
| 5 | familial Mediterranean fever | 0.9913 |
| 6 | primary immunodeficiency due to a genetic defect in innate immunity | 0.9867 |
| 7 | sitosterolemia | 0.9859 |
| 8 | Smouldering systemic mastocytosis | 0.9824 |
| 9 | systemic mastocytosis | 0.9820 |
| 10 | lymphoadenopathic mastocytosis with eosinophilia | 0.9808 |
...
- [PubMed: Colchicine](https://pubmed.ncbi.nlm.nih.gov/?term=Colchicine)
- [ClinicalTrials.gov](https://clinicaltrials.gov/search?term=Colchicine)
