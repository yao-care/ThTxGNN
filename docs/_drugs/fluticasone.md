...
layout: default
title: "Fluticasone"
description: "รายงานการวิเคราะห์ศักยภาพการใช้ยา Fluticasone ในข้อบ่งใช้ใหม่ - ThTxGNN"
...
| รายการ | รายละเอียด |
|--------|------------|
| **DrugBank ID** | [DB13867](https://go.drugbank.com/drugs/DB13867) |
| **เลขทะเบียนยา** | 1A 63/67 |
| **ข้อบ่งใช้เดิม** | โรคหอบหืด, โรคจมูกอักเสบ |
| **ข้อบ่งใช้ที่คาดการณ์อันดับ 1** | migraine disorder |
| **คะแนน TxGNN สูงสุด** | 0.9920 |
| **ระดับหลักฐาน** | L4 |
...
|:------:|---------------------|:-----------:|
| 1 | migraine disorder | 0.9920 |
| 2 | Prinzmetal angina | 0.9919 |
| 3 | migraine with brainstem aura | 0.9909 |
| 4 | cystic teratoma | 0.9857 |
| 5 | spinal cord dermoid cyst | 0.9853 |
| 6 | disease of orbital part of eye adnexa | 0.9851 |
| 7 | exostosis | 0.9851 |
| 8 | disease of orbital region | 0.9847 |
| 9 | dermoid cyst of ovary | 0.9847 |
| 10 | eye disease | 0.9846 |
...
- [DrugBank: Fluticasone](https://go.drugbank.com/drugs/DB13867)
- [PubMed: Fluticasone](https://pubmed.ncbi.nlm.nih.gov/?term=Fluticasone)
- [ClinicalTrials.gov](https://clinicaltrials.gov/search?term=Fluticasone)
