...
description: "Salicylic Acid 的老藥新用潛力分析。模型預測等級 L5，包含 10 個預測適應症。查看 AI 預測與臨床證據完整報告。"
parent: 僅模型預測 (L5)
nav_order: 154
evidence_level: L5
indication_count: 10
...
<p class="key-answer" data-question="Salicylic Acid 可以用於治療什麼新適應症？">
...
<details class="indication-section">
<summary>
<span class="indication-name">3. brachydactyly-syndactyly syndrome</span>
<span class="evidence-badge evidence-L5">L5</span>
...
<details class="indication-section">
<summary>
<span class="indication-name">6. acromesomelic dysplasia, Hunter-Thompson type</span>
<span class="evidence-badge evidence-L5">L5</span>
...
<details class="indication-section">
<summary>
<span class="indication-name">8. myosclerosis</span>
<span class="evidence-badge evidence-L5">L5</span>
...
<details class="indication-section">
<summary>
<span class="indication-name">9. brachyolmia</span>
<span class="evidence-badge evidence-L5">L5</span>
...
<details class="indication-section">
<summary>
<span class="indication-name">10. spondyloarthropathy, susceptibility to</span>
<span class="evidence-badge evidence-L5">L5</span>
...
**APA 格式：**
```
ThTxGNN. (2026). Salicylic Acid老藥新用驗證報告. https://thtxgnn.yao.care/drugs/salicylic_acid/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_salicylic_acid,
  title = {Salicylic Acid老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/salicylic_acid/}
}
```
