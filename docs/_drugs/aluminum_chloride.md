...
<p class="key-answer" data-question="Aluminum Chloride 可以用於治療什麼新適應症？">
...
**理由：**
TxGNN 預測的新適應症（脂漏性角化症、脂漏性皮膚炎）缺乏機轉上的合理性支持。Aluminum chloride 的收斂作用與這些疾病的病理生理學關聯不明確。
...
**APA 格式：**
```
ThTxGNN. (2026). Aluminum Chloride老藥新用驗證報告. https://thtxgnn.yao.care/drugs/aluminum_chloride/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_aluminum_chloride,
  title = {Aluminum Chloride老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/aluminum_chloride/}
}
```
