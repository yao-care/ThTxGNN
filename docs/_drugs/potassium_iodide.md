...
---
*報告產生日期: 2026-02-11*
*資料來源: TxGNN預測、ClinicalTrials.gov、PubMed、泰國食品藥物管理署、DDInter*
...
**APA 格式：**
```
ThTxGNN. (2026). Potassium Iodide老藥新用驗證報告. https://thtxgnn.yao.care/drugs/potassium_iodide/
```

**BibTeX 格式：**
```bibtex
@misc{thtxgnn_potassium_iodide,
  title = {Potassium Iodide老藥新用驗證報告},
  author = {ThTxGNN Team},
  year = {2026},
  url = {https://thtxgnn.yao.care/drugs/potassium_iodide/}
}
```
