# ThTxGNN - ประเทศไทย: การคาดการณ์การนำยาเก่ามาใช้ใหม่

> 本專案由 **藥提醒科技有限公司**（[yao.care](https://www.yao.care)）開發與維運。
> ThTxGNN 站台：<https://thtxgnn.yao.care/>｜產品總覽：<https://www.yao.care/medical/txgnn/>

[![Website](https://img.shields.io/badge/Website-thtxgnn.yao.care-blue)](https://thtxgnn.yao.care)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

Drug repurposing predictions for Thailand Thai FDA-approved drugs using the TxGNN model.
...
|------|------|
| **Drug Reports** | 151 |
| **Total Predictions** | 222,094 |
| **Unique Drugs** | 152 |
| **Unique Indications** | 12,298 |
| **DDI Data** | 302,516 |
| **DFI Data** | 857 |
| **DHI Data** | 35 |
| **DDSI Data** | 8,359 |
| **FHIR Resources** | 125 MK / 1,130 CUD |
...
| **L5** | 151 | Computational prediction only |
...
| Metric | Value |
|------|------|
| Thai FDA Total Drugs | 155 |
| Mapped to DrugBank | 152 (98.1%) |
...
PYTHONPATH=src python -m thtxgnn.predict.txgnn_model
```

| Metric | Value |
|------|------|
| Total DL Predictions | 221,949 |
| Unique Drugs | 152 |
| Unique Indications | 12,298 |
...
flowchart TD
    ...
    subgraph B["Step 1: DrugBundle Collector"]
        B1["Drug-level: Thai FDA, DDI, DrugBank"]
...
| File | Download |
|------|------|
| Thai FDA Data | [Thailand Food and Drug Administration](https://www.fda.moph.go.th/) |
...
|------|------|------|------|
| **Drug Data** | Thai FDA | [Thailand Food and Drug Administration](https://www.fda.moph.go.th/) | Thailand |
...
```mermaid
flowchart TD
    FDA["Thai FDA Data"] --> proc["process_fda_data.py"]
    TxGNN["TxGNN Data"] --> prep["prepare_external_data.py"]

    proc --> json["th_fda_drugs.json"]
...
@software{thtxgnn2026,
  author       = {Yao.Care},
  title        = {ThTxGNN: Drug Repurposing Validation Reports for Thailand Thai FDA Drugs},
  year         = 2026,
  publisher    = {GitHub},
