#!/usr/bin/env python3
"""
Integrate KG and DL prediction results for ThTxGNN.
"""
...
def integrate_predictions(kg: pd.DataFrame, dl: pd.DataFrame, mapping: pd.DataFrame) -> pd.DataFrame:
    ...
    # Rename to standard
    kg_unified = kg_unified.rename(columns={KG_COLS["ingredient"]: "ingredient"})
...
def main():
    ...
    print("=" * 60)
    print("ThTxGNN Prediction Integration")
    print("=" * 60)
