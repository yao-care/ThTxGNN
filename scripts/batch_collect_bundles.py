...
import pandas as pd
from thtxgnn.collectors import DrugBundleAggregator
from thtxgnn.paths import get_bundles_dir, slugify
...
def preload_predictions(min_score: float = 0.99, top_n: int = 10) -> dict[str, list]:
    ...
    """
    from thtxgnn.collectors.drug_bundle import PredictedIndication
    from thtxgnn.collectors.known_relations import KnownRelationsChecker
...
def patch_single_drug(
    ...
    """
    from thtxgnn.collectors.drug_bundle import DrugBundle
